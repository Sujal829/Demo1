...
import TickerRibbon from './components/Dashboard/TickerRibbon';
  ...
  return (
    <Router>
      <div className="min-h-screen bg-background text-white font-sans flex flex-col">
        {/* Navigation Bar */}
        <nav className="border-b border-gray-800 bg-card p-4 relative z-20">
          <div className="container mx-auto flex gap-6 items-center">
            ...
            <div className="flex gap-4">
              ...
              <Link to="/chart" className="hover:text-primary transition-colors font-medium">Advanced Chart</Link>
            </div>
